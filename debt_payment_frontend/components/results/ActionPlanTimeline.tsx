...
import { CheckCircle2, CalendarDays, Trophy, TrendingUp, ChevronDown, ChevronUp } from "lucide-react";
...
export default function ActionPlanTimeline({ milestones, paymentSchedule, formatDateString }: ActionPlanTimelineProps) {
    ...
    return (
        <div className="mb-4 border border-gray-200 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-900 shadow-sm text-card-foreground overflow-hidden">
